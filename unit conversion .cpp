...
{     // ye wala class only temp related convrsion ke liye hai......
public:
       void cel_f();
       void f_cel();
       void cel_k();
...
//  sare methods yaha pe hai aur conversion method bhi isi ke andar hai.....
...
int main()
{
   ...
   mainmenu:cout <<"Press 1: for length conversion"<<endl;
    	...
    	for2:	cout<<"Press 1 :for mmSq to cmSq"<<endl;
